...
from jablo2esphome.const import STATE_OFF, STATE_ON
import pytest
...
def state_updates():
	...
	jablotron._state_lock = threading.RLock()
	callbacks = []
	jablotron._rt = Mock()
	jablotron._rt.call_soon_threadsafe.side_effect = lambda callback, *args: callbacks.append((callback, args))
	entity = Mock()
